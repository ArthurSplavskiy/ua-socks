			...
			<div className={'Social-left'}>
				...
				<div className='Social-item'>
					<a
						...
						{/* {`/images/social-icon/some-01.png`} */}
				...
				<div className='Social-item'>
					<a
						...
						{/* {`/images/social-icon/some-02.png`} */}
				...
				<div className='Social-item'>
					<a
						...
						{/* {`/images/social-icon/some-03.png`} */}
